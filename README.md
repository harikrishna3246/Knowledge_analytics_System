...
5. Set **Build Command**: `pip install -r requirements.txt && python download_nltk_data.py`
...
8. Deploy the service. Note the generated URL (e.g., `https://your-app.onrender.com`).
...
4. Add Environment Variable:
   - `REACT_APP_API_BASE_URL`: The Render backend URL (e.g., `https://your-app.onrender.com`)
   - `REACT_APP_GOOGLE_CLIENT_ID`: Your Google OAuth client ID
5. Deploy. Vercel will automatically build and deploy the React app.

### **Post-Deployment Notes**

- Update the backend CORS origins in `main.py` to allow requests from your Vercel domain for better security.
- Ensure MongoDB Atlas allows connections from Render's IP ranges if needed.
- Test the deployed app to verify API calls work correctly.

---

**KnowledgeAI System** – _Bridging the gap between raw data and true understanding._ 🚀
